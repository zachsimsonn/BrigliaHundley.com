...
const Hero = ({ data, editableContent }) => {
  ...
  return (
    <section className="relative text-white overflow-hidden min-h-screen w-full" style={{ margin: 0, padding: 0 }}>
      ...
      <div className={`absolute inset-0 w-full h-full transition-opacity duration-1000 ease-in-out ${currentSlide === 0 ? 'opacity-100 z-20' : 'opacity-0 z-10'}`}>
        {/* Video Background */}
      ...
      <div className={`absolute inset-0 w-full h-full transition-opacity duration-1000 ease-in-out ${currentSlide === 1 ? 'opacity-100 z-20' : 'opacity-0 z-10'}`}>
        {/* Image Background */}
        <div className="absolute inset-0 w-full h-full z-0 overflow-hidden">
          <img
      ...
      {/* Subtle slide indicators (optional) */}
...
export default Hero;
      ...
      <div className={`absolute inset-0 w-full h-full transition-opacity duration-500 ${currentSlide === 1 ? 'opacity-100 z-20' : 'opacity-0 z-10'}`}>
        ...
        <div className="absolute inset-0 w-full h-full z-0 overflow-hidden">
          ...
          {/* Subtle overlay to ensure arrows are visible */}
          <div className="absolute inset-0 bg-black/5" style={{ margin: 0, padding: 0 }}></div>
        </div>
      </div>
